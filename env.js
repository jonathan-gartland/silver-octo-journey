 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.practiceapp4.staging
 */

// TODO: Replace these values with your own

const BUNDLE_ID = 'com.practiceapp4'; // ios bundle id
const PACKAGE = 'com.practiceapp4'; // android package name
const NAME = 'PracticeApp4'; // app name
const EXPO_ACCOUNT_OWNER = 'jonathan-gartland'; // expo account owner
const EAS_PROJECT_ID = '1694a458-f836-4d19-bdc4-e2dfc0f0c229'; // eas project id
const SCHEME = 'PracticeApp4'; // app scheme
